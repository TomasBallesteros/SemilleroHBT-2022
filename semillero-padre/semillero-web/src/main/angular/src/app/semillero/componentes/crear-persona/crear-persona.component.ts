...
export class CrearPersonaComponent implements OnInit {
  ...
  public imagen : any;
  public idComic : any;
  public listaComics : Array<ObjetoComicDTO>;
  ...
  ngOnInit() {
    ...
    this.listaComics = new Array<ObjetoComicDTO>()
    let comicPrimero = new ObjetoComicDTO(1, "Iron Man", "Marvel", TematicaEnum.CIENCIA_FICCION, 100, 2000, "Marvel Comics", true, new Date(), EstadoEnum.ACTIVO);
    let comicSegundo = new ObjetoComicDTO(2, "Capitan America", "Marvel", TematicaEnum.CIENCIA_FICCION, 100, 2000, "Marvel Comics", true, new Date(), EstadoEnum.ACTIVO);
    let comicTercero = new ObjetoComicDTO(3, "Spider Man", "Marvel", TematicaEnum.CIENCIA_FICCION, 100, 2000, "Marvel Comics", true, new Date(), EstadoEnum.ACTIVO);
    let comicCuarto = new ObjetoComicDTO(4, "Thor", "Marvel", TematicaEnum.CIENCIA_FICCION, 100, 2000, "Marvel Comics", true, new Date(), EstadoEnum.ACTIVO);
    let comicQuinto = new ObjetoComicDTO(5, "Hulk", "Marvel", TematicaEnum.CIENCIA_FICCION, 100, 2000, "Marvel Comics", true, new Date(), EstadoEnum.ACTIVO);
    this.listaComics.push(comicPrimero);
    this.listaComics.push(comicSegundo);
    this.listaComics.push(comicTercero);
    this.listaComics.push(comicCuarto);
    this.listaComics.push(comicQuinto);
