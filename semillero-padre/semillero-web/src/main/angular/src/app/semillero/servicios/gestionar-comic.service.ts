...
export class GestionarComicService {
  ...
  public eliminarComic(id : string) : Observable<any>{

    return this.httpClient.post('http://localhost:8085/semillero-servicios/rest/gestionarComicRest/eliminarComic', id);
  }
}
